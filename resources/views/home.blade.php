...
<link href="{!! asset('theme/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css')!!}" rel="stylesheet" type="text/css" />
<link href="{!! asset('theme/assets/global/plugins/morris/morris.css')!!}" rel="stylesheet" type="text/css" />
<link href="{!! asset('theme/assets/global/plugins/fullcalendar/fullcalendar.min.css')!!}" rel="stylesheet" type="text/css" />
<link href="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/jqvmap.css')!!}" rel="stylesheet" type="text/css" />
...
@section('content')
        ...
        <div class="container-fluid">
                            ...
                            <div class="progress-info">
                                <div class="progress">
                                        <span style="width: 45%;" class="progress-bar progress-bar-success blue-sharp">
                                            <span class="sr-only">45% progress</span>
                                        </span>
                                </div>
                                <div class="status">
                                    <div class="status-title"> progress </div>
                    ...
                    <div class="col-lg-6 col-xs-12 col-sm-12">
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn blue btn-outline btn-circle btn-sm" href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Actions
                                        ...
                                        <ol>
                                            <li class="selected" data-date="16/01/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue-madison">Andres Iniesta</a>
                                                    </div>
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    ...
                                                    <a href="#" class="btn btn-circle red btn-outline">Read More</a>
                                                    <a href="#" class="btn btn-circle btn-icon-only blue">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-circle btn-icon-only green pull-right">
                                            ...
                                            <li data-date="28/02/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue-madison">Hugh Grant</a>
                                                    </div>
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, finibus eu ex. Integer efficitur leo eget dolor
                                                        ...
                                                        risus sed sodales.</p>
                                                    <a href="#" class="btn btn-circle btn-outline green-jungle">Download Shipment List</a>
                                            ...
                                            <li data-date="20/04/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue">Rory Matthew</a>
                                                    </div>
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    ...
                                                    <a href="#" class="btn btn-circle red">Read More</a>
                                                </div>
                                            </li>
                                            <li data-date="20/05/2014">
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, finibus eu ex. Integer efficitur leo eget dolor
                                                        ...
                                                        est rhoncus volutpat. Nullam interdum, neque quis vehicula ornare, lacus elit dignissim purus, quis ultrices erat tortor eget felis. Cras commodo id massa at condimentum. Praesent dignissim luctus
                                                        risus sed sodales.</p>
                                                    <a href="#" class="btn btn-circle green-turquoise">Read More</a>
                                                </div>
                                            </li>
                                            <li data-date="09/07/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue-madison">Matt Goldman</a>
                                                    </div>
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    ...
                                                    <a href="#" class="btn btn-circle btn-outline purple-medium">View Summary</a>
                                                    <div class="btn-group dropup pull-right">
                                            ...
                                            <li data-date="30/08/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue-madison">Rory Matthew</a>
                                                    </div>
                                            ...
                                            <li data-date="15/09/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue-madison">Jessica Wolf</a>
                                                    </div>
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                                        qui ut.</p>
                                                    <a href="#" class="btn btn-circle green-sharp">Read More</a>
                                                </div>
                                            </li>
                                        ...
                                        <ol>
                                            <li class="selected" data-date="16/01/2014">
                                                ...
                                                <div class="mt-author">
                                                    ...
                                                    <div class="mt-author-name">
                                                        <a href="#" class="font-blue-madison">Lisa Bold</a>
                                                    </div>
                                                ...
                                                <div class="mt-content border-grey-steel">
                                                    ...
                                                    <a href="#" class="btn btn-circle dark btn-outline">Read More</a>
                                                    <a href="#" class="btn btn-circle btn-icon-only green pull-right">
                                                        <i class="fa fa-twitter"></i>
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="easy-pie-chart">
                                            <div class="number transactions" data-percent="55">
                                                <span>+55</span>% </div>
                                            <a class="title" href="#"> Transactions
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    ...
                                    <a class="btn btn-circle btn-icon-only btn-default fullscreen" data-container="false" data-placement="bottom" href="#"> </a>
                                    <a class="btn btn-circle btn-icon-only btn-default" href="#">
                                        <i class="icon-trash"></i>
                                    </a>
                                </div>
                                ...
                                <div id="region_statistics_content" class="display-none">
                                    <div class="btn-toolbar margin-bottom-10">
                                        ...
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a href="#" id="regional_stat_world"> World </a>
                                                </li>
                                                <li>
                                                    <a href="#" id="regional_stat_usa"> USA </a>
                                                </li>
                                                <li>
                                                    <a href="#" id="regional_stat_europe"> Europe </a>
                                                </li>
                                                <li>
                                                    <a href="#" id="regional_stat_russia"> Russia </a>
                                                </li>
                                                <li>
                                                    <a href="#" id="regional_stat_germany"> Germany </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6 col-xs-12 col-sm-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn green-haze btn-outline btn-circle btn-sm" href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Actions
                                            <i class="fa fa-angle-down"></i>
                                        </a>
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                            ...
                                            <div class="mt-body">
                                                ...
                                                <div class="mt-stats">
                                                    <div class="btn-group btn-group btn-group-justified">
                                                        <a href="#" class="btn font-red">
                                                            <i class="icon-bubbles"></i> 1,7k </a>
                                                        <a href="#" class="btn font-green">
                                                            <i class="icon-social-twitter"></i> 2,6k </a>
                                                        <a href="#" class="btn font-yellow">
                    ...
                    <div class="col-lg-6 col-xs-12 col-sm-12">
                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn red btn-outline btn-circle btn-sm" href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> Actions
                                            <i class="fa fa-angle-down"></i>
                                        </a>
                                        <ul class="dropdown-menu pull-right">
                                            <li>
            ...
            <!-- BEGIN FOOTER -->
            <p class="copyright"> 2017 &copy; TRAIN SMART By ABDUL REHMAN
...
<script src="{!! asset('theme/assets/global/plugins/moment.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/morris/morris.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/morris/raphael-min.js')!!}" type="text/javascript"></script>
...
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/amcharts.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/serial.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/pie.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/radar.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/themes/light.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/themes/patterns.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amcharts/themes/chalk.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/ammap/ammap.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/amcharts/amstockcharts/amstock.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/fullcalendar/fullcalendar.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/horizontal-timeline/horizontal-timeline.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/flot/jquery.flot.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/flot/jquery.flot.resize.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/flot/jquery.flot.categories.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jquery.sparkline.min.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js')!!}" type="text/javascript"></script>
<script src="{!! asset('theme/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js')!!}" type="text/javascript"></script>
