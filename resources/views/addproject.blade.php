...
@endif
                                        ...
                                        <!-- BEGIN FORM-->
                                        <form action="{{ route('project.add') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="projectid" value="{{rand(1000,1000000)}}" />
                                                ...
                                                <select class="form-control" name="project_category" required>
                                                    ...
                                                    <option value="{{$row->catid.'-'.$row->cattitle}}">{{$row->cattitle}}</option>
...
<input type="text" name="project_title" placeholder="Project Title" class="form-control" value="{{ old('project_title')}}" required>    
            ...
            <input type="text" class="form-control" placeholder="Project Starting Date" name="startdate" required="required">
            ...
            <i class="fa fa-calendar"></i>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
            <input type="text" class="form-control" placeholder="Project Ending Date" name="enddate" required>
            <span class="input-group-btn">
            <button class="btn default" type="button">
            <i class="fa fa-calendar"></i>
            </button>
                                ...
                                <textarea class=" form-control" rows="12" name="editor1"  required="required">{{ old('editor1')}}</textarea>
