    ...
    <div class="container-fluid">
        <div class="page-content">
            ...
            <div class="breadcrumbs">
                <h1 style="text-transform: none;">View Training Methods List</h1>
                <ol class="breadcrumb">
                    <li>
                        Home
                    </li>
                    ...
                    <li class="active">Methods List</li>
                </ol>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">View Training Methods</span>
                                        </div>
...
<div class="portlet-body" style="padding:10px;">
                                                ...
                                                <div class="table-toolbar">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="btn-group">
    <a href="{{url('training/addmethod')}}"  class="btn sbold green"> Add New
...
<script type="text/javascript">
    ...
    if(deletecat==true)
    {
        window.location.href="{{url('training/deletemethod/')}}/"+catid;
    }
