    ...
    <div class="container-fluid">
        <div class="page-content">
            ...
            <div class="breadcrumbs">
                <h1 style="text-transform: none;">Add Training Method</h1>
                <ol class="breadcrumb">
                    <li>
                        Home
                    </li>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">Add new Training Method</span>
                                        </div>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <form action="{{route('method.add')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                   <label>Training Method <span style="color:red;">*</span></label> 
                                                    
                                                    <input type="text" value="{{old('method')}}" class="form-control" placeholder="Training Method" name="method" required="required">
                                                     @if($errors->has('method'))
                                                    <span style="color:red;">{{$errors->first('method')}}</span>
                                                @endif
                                                </div>    
