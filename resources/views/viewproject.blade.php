    ...
    <div class="container-fluid">
        <div class="page-content">
            ...
            <div class="breadcrumbs">
                <h1 style="text-transform: none;">View Project List</h1>
                <ol class="breadcrumb">
                    <li>
                        Home
                    </li>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">View Projects</span>
                                        </div>
...
<div class="portlet-body" style="padding:10px;">
                                                ...
                                                <div class="table-toolbar">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="btn-group">
    <a href="{{url('project/add')}}" id="sample_editable_1_new" class="btn sbold green"> Add New
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li>
                        <a href="{{url('/project/singleview/'.$record->id.'')}}">
                        <i class="icon-eye"></i> View  </a>
                                                                        </li>
                        <li>
                     <a href="{{url('/project/settings/'.$record->projectid.'')}}">
