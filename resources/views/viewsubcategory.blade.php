    ...
    <div class="container-fluid">
        <div class="page-content">
            ...
            <div class="breadcrumbs">
                <h1 style="text-transform: none;">View Training Sub Categories List</h1>
                <ol class="breadcrumb">
                    <li>
                        Home
                    </li>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">View Training Sub Categories</span>
                                        </div>
...
<div class="portlet-body" style="padding:10px;">
                                                ...
                                                <div class="table-toolbar">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="btn-group">
    <a href="{{url('training/addsubcategory')}}"  class="btn sbold green"> Add New
...
<script type="text/javascript">
    ...
    if(deletecat==true)
    {
        window.location.href="{{url('training/deletesubcategory/')}}/"+catid;
    }
