    ...
    <div class="container-fluid">
        <div class="page-content">
            ...
            <div class="breadcrumbs">
                <h1 style="text-transform: none;">Add a new Project</h1>
                <ol class="breadcrumb">
                    <li>
                        Home
                    </li>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">Add new Project</span>
                                        </div>
                                        
                                        <div class="actions">
                                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                                        
                                                        <label class="btn btn-transparent dark btn-outline btn-circle btn-sm" id="printclick">
                                                            
                                                            <input type="radio" name="options" class="toggle" id="option2"><i class="fa fa-print"></i>&nbsp;Print
                                                        
                                                        </label>
                                                        
                                                        <label class="btn btn-transparent dark btn-outline btn-circle btn-sm" id="editbtn">
                                                            
                                                            <input type="radio" name="options" class="toggle" id="option2"><i class="fa fa-edit"></i>&nbsp;Edit
                                                        
                                                        </label>
                                                        
                                                         <label class="btn btn-transparent  btn-outline btn-circle btn-sm" id="deletenow" style="background-color:red;color:white;">
                                    ...
                                    <div class="col-md-12">
                                        <input type="hidden" id="pid" value="{{$record->id}}">
                                        <table class="table" id="printTable">
                                            
                                            <tr>
                                            <td class="info">Project Logo </td>
                                            <td><img src="{!! asset('storage/images/'.$record->logo.'')!!}" class="img-responsive img-thumbnail" alt="{{$record->title}}" style="width:50%;height:auto;"> </td>    
                                            </tr>
                                            <tr>
                                            <td class="active">Project Id</td>
                                            <td>{{$record->projectid}}</td>
                                            </tr>
                                            <tr>
                                            <td class="success">Project Category</td>
                                            <td><?php $exp = explode("-",$record->projectcate); ?>
                                                {{$exp[1]}}
                                                </td>
                                            </tr>
                                            <tr>    
                                            <td class="warning">Project Title</td>
                                            <td>{{$record->title}}</td>
                                            </tr>
                                            <tr>
                                            <td class="danger">Project Duration</td>
                                            <td>{{$record->startdate." to ".$record->enddate}}</td>    
                                            </tr>
                                            <tr>
                                            <td class="success">Project Description</td>
