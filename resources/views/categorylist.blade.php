    ...
    <div class="container-fluid">
        <div class="page-content">
            ...
            <div class="breadcrumbs">
                <h1 style="text-transform: none;">View Project Categories List</h1>
                <ol class="breadcrumb">
                    <li>
                        Home
                    </li>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">View Projects Categories</span>
                                        </div>
...
<div class="portlet-body" style="padding:10px;">
                                                ...
                                                <div class="table-toolbar">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="btn-group">
    <a href="javascript:;" id="sample_editable_1_new" class="btn sbold green" data-toggle="modal" data-target="#mymodal" data-backdrop="static" data-keyboard="false"> Add New
...
<tbody>
    ...
    @forelse($plist as $record)
    
    <tr class="odd gradeX">
        
    <td>{{$var}}</td>
        
    <td>{{$record->cattitle}} </td>
    ...
    <td>
    <div class="btn-group">
    <button class="btn btn-xs btn-danger deletecategory" id="{{$record->catid}}">Delete
...
<script type="text/javascript">
    ...
    if(deletecat==true)
    {
        window.location.href="{{url('project/deletecat/')}}/"+catid;
    }
